...
const variants = {
  primary:
    'border-transparent bg-primary hover:bg-primary/75 active:bg-primary/50 disabled:bg-primary/25 disabled:text-dark/75 text-light',
  danger:
    'border-transparent bg-danger hover:bg-danger/75 active:bg-danger/50 disabled:bg-danger/25 disabled:text-dark/75 text-light',
  warning:
    'border-transparent bg-warning hover:bg-warning/75 active:bg-warning/50 disabled:bg-warning/25 disabled:text-dark/75 text-dark',
  success:
    'border-transparent bg-success hover:bg-success/75 active:bg-success/50 disabled:bg-success/25 disabled:text-dark/75 text-dark',
  muted:
